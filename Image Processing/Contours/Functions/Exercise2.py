...
img = cv2.imread('C:/Users/Hardik/Documents/OpeCV/Tut9/a.jpg')
imgray = cv2.cvtColor(img,cv2.COLOR_BGR2GRAY)
ret,thresh = cv2.threshold(imgray,127,255,cv2.THRESH_BINARY+cv2.THRESH_OTSU)
_,contours,_ = cv2.findContours(thresh,cv2.RETR_TREE,cv2.CHAIN_APPROX_NONE)
img2 = cv2.imread('C:/Users/Hardik/Documents/OpeCV/Tut9/m.jpg')
...
img3 = cv2.imread('C:/Users/Hardik/Documents/OpeCV/Tut9/v.jpg')
